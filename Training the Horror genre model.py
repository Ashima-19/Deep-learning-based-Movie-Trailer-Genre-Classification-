...
traindf=pd.read_csv("Horror.csv",dtype=str)
traindf.head(10)
...
history=model4.fit_generator(train_generator, epochs=80, steps_per_epoch=105,validation_data=valid_generator, validation_steps=6,callbacks=callbacks_list, verbose=1)
model4.save_weights("horror.h5")
