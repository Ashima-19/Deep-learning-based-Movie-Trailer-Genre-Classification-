...
traindf=pd.read_csv("Romance.csv",dtype=str)
traindf.head(10)
...
history=model4.fit_generator(train_generator, epochs=80, steps_per_epoch=270,validation_data=valid_generator, validation_steps=14,callbacks=callbacks_list, verbose=1)
model4.save_weights("romance.h5")
